...
class TencentDownloaderMiddleware(object):
    ...
    user_agent_list = [# Opera
        ...
        # 猎豹浏览器
        "Mozilla/5.0 (Windows NT 6.1; WOW64) AppleWebKit/537.1 (KHTML, like Gecko) Chrome/21.0.1180.71 Saf\
        ari/537.1 LBBROWSER",
        ...
        "Mozilla/5.0 (Macintosh; Intel Mac OS X 10_8_0) AppleWebKit/536.3 (KHTML, like Gecko) Chrome/19.0.1\
        063.0 Safari/536.3",
